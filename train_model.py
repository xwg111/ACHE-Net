...
def main_loop(batch_size=config.batch_size, model_type='', tensorboard=True):
    ...
    if model_type == 'ECHF':
        ...
        model = ECHF(n_channels=config.n_channels,n_classes=config.n_labels)
    ...
    logger.info('Training on ' +str(platform.uname()[1])) #os.uname() can't use in windows！！！！！！！！！！！！！！！！！！！！！
