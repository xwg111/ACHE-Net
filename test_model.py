...
if __name__ == '__main__':
    ...
    if config.task_name =="Glas":
        ...
        model_path = "./Glas/"+model_type+"/"+test_session+"/models/epoch258-dice0.8937-Glas"+".pth.tar"
        #model_path = "./Glas/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="BUSI":
        test_num = 120
        model_type = config.model_name
        model_path = "./BUSI/"+model_type+"/"+test_session+"/models/epoch136-dice0.7623-BUSI"+".pth.tar"
        #model_path = "./BUSI/"+model_type+"/"+test_session+"/models/best_model-"+model_type+".pth.tar"

    elif config.task_name =="CVC-ClinicDB":
        test_num = 122
        model_type = config.model_name
        model_path = "./CVC-ClinicDB/"+model_type+"/"+test_session+"/models/epoch299-dice0.8741-CVC-ClinicDB"+".pth.tar"
        ...
        test_num = 200
        model_type = config.model_name
        model_path = "./Kvasir-SEG/"+model_type+"/"+test_session+"/models/epoch77-dice0.8438-Kvasir-SEG"+".pth.tar"
